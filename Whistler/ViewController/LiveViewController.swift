...
class LiveViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, GADBannerViewDelegate {
    ...
    func adViewDidReceiveAd(_ bannerView: GADBannerView) {
        ...
        Analytics.logEvent("adViewDidReceiveAd", parameters: [ "screen": "Live" ])
    }
    ...
    func adView(_ bannerView: GADBannerView,
        ...
        Analytics.logEvent("adView:didFailToReceiveAdWithError", parameters: [ "screen": "Live", "error": "error.localizedDescription" ])
    }
    ...
    func adViewWillPresentScreen(_ bannerView: GADBannerView) {
        ...
        Analytics.logEvent("adViewWillPresentScreen", parameters: [ "screen": "Live" ])
    }
    
    /// Tells the delegate that the full-screen view will be dismissed.
    func adViewWillDismissScreen(_ bannerView: GADBannerView) {
        print("adViewWillDismissScreen")
        Analytics.logEvent("adViewWillDismissScreen", parameters: [ "screen": "Live" ])
    }
    
    /// Tells the delegate that the full-screen view has been dismissed.
    func adViewDidDismissScreen(_ bannerView: GADBannerView) {
        print("adViewDidDismissScreen")
        Analytics.logEvent("adViewDidDismissScreen", parameters: [ "screen": "Live" ])
    }
    ...
    func adViewWillLeaveApplication(_ bannerView: GADBannerView) {
        ...
        Analytics.logEvent("adViewWillLeaveApplication", parameters: [ "screen": "Live" ])
    }
}
